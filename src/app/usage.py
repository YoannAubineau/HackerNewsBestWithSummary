...
SVG bar chart of the last N days' deltas into ``artifacts/usage-chart.svg``.
...
_CHART_PATH = Path("artifacts/usage-chart.svg")
_BADGE_PATH = Path("artifacts/llm-cost.json")
